            ...
            if (logoutBtn) {
                logoutBtn.addEventListener('click', () => {
                    const _logoutPopupId = window.Popup.show({
                        title: 'Select Logout Option',
                        size: 'sm',
                        closeable: true,
                        content: `
                            <div style="text-align: center; padding: var(--ds-space-2) 0 var(--ds-space-2);">
                                <div style="width: 56px; height: 56px; border-radius: 50%; background: #e0e7ff; display: flex; align-items: center; justify-content: center; margin: 0 auto var(--ds-space-4); color: #2563eb; font-size: 24px;">
                                    <i class="fas fa-sign-out-alt"></i>
                                </div>
                                <p style="color: var(--ds-text-primary); font-weight: var(--ds-weight-semibold); font-size: var(--ds-text-md); margin-bottom: var(--ds-space-2);">How would you like to log out?</p>
                                <p style="color: var(--ds-text-secondary); font-size: var(--ds-text-xs); line-height: 1.5; margin-bottom: var(--ds-space-5);">
                                    The Desktop app performs continuous Tally data synchronization. You can log out of only Web &amp; Mobile apps to keep your syncing active.
                                </p>
                                <div style="display: flex; flex-direction: column; gap: var(--ds-space-3);">
                                    <button id="logoutThisDevice_btn"
                                        style="width: 100%; padding: 13px var(--ds-space-5); border-radius: var(--ds-radius-lg); font-size: var(--ds-text-sm); font-weight: var(--ds-weight-semibold); color: var(--ds-text-primary); cursor: pointer; background: #fff; border: 1px solid var(--ds-border-default); transition: all 0.2s;"
                                        onmouseover="this.style.background='var(--ds-bg-surface-sunken)'; this.style.borderColor='#c7d2fe'"
                                        onmouseout="this.style.background='#fff'; this.style.borderColor='var(--ds-border-default)'">
                                    ...
                                    <button id="logoutCancel_btn"
                                        style="width: 100%; padding: 13px var(--ds-space-5); border-radius: var(--ds-radius-lg); font-size: var(--ds-text-sm); font-weight: var(--ds-weight-semibold); color: #dc2626; cursor: pointer; background: #fef2f2; border: 1px solid transparent; transition: all 0.2s;"
